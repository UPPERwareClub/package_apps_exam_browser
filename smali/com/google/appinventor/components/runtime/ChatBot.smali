...
.method private performRequest(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "performRequest: apiKey = "
    ...
    .line 268
    invoke-static {v3}, Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$token;->parseFrom([B)Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$token;
    ...
    .line 270
    invoke-virtual {v5, v3}, Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;->setToken(Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$token;)Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;

    move-result-object v3

    .line 271
    invoke-virtual {v3, p1}, Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;->setUuid(Ljava/lang/String;)Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;
    ...
    .line 272
    invoke-virtual {v3, v5}, Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;->setProvider(Ljava/lang/String;)Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;

    move-result-object v3

    .line 273
    invoke-virtual {v3, p2}, Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;->setQuestion(Ljava/lang/String;)Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request$Builder;

    move-result-object p2

    .line 274
    iget-object v3, p0, Lcom/google/appinventor/components/runtime/ChatBot;->system:Ljava/lang/String;
    ...
    const-string v3, "https://chatbot.appinventor.mit.edu/chat/v1"
    ...
    .line 289
    :try_start_2
    iget-object v1, p0, Lcom/google/appinventor/components/runtime/ChatBot;->sslSockFactory:Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {p1, v1}, Lcom/google/appinventor/components/runtime/chatbot/ChatBotToken$request;->writeTo(Ljava/io/OutputStream;)V
    ...
    .line 299
    invoke-virtual {p0, v1}, Lcom/google/appinventor/components/runtime/ChatBot;->GotResponse(Ljava/lang/String;)V

    goto :goto_1

    .line 301
    :cond_4
    invoke-static {p2, v0}, Lcom/google/appinventor/components/runtime/ChatBot;->getResponseContent(Ljavax/net/ssl/HttpsURLConnection;Z)Ljava/lang/String;

    move-result-object p1

    .line 302
    invoke-virtual {p0, v2, p1}, Lcom/google/appinventor/components/runtime/ChatBot;->ErrorOccurred(ILjava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    .line 313
    :try_start_4
    invoke-static {v1, v0}, Lcom/google/appinventor/components/runtime/ChatBot;->getResponseContent(Ljavax/net/ssl/HttpsURLConnection;Z)Ljava/lang/String;
